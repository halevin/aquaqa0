...
public interface CommentRepository extends CrudRepository<ExecBlockComment, Long> {

    List<ExecBlockComment> findByExecBlockOrderByTimestampDesc(ExecBlock execBlock);
