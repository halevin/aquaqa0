...
public class DTDataReducer implements Serializable{

    private static final long serialVersionUID = -5310788150751934764L;

    private String userId;
    private User user;
    private DTArcNode arcNode;
    private List<String> qualifications;
    private List<Availability> availabilityList;
    private int load;

    public DTDataReducer(){
    }
    ...
    public DTArcNode getArcNode() {
        return arcNode;
    }

    public void setArcNode(DTArcNode arcNode) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        DTDataReducer other = (DTDataReducer) obj;
        if (getUser() == null) {
