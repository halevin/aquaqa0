...
@Entity
@Table(name="XML_OBSPROJECT_ENTITIES")
public class ObsProjectEntity implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5584788279393345143L;
